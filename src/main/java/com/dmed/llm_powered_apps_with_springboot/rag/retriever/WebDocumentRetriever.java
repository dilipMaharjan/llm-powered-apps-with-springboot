package com.dmed.llm_powered_apps_with_springboot.rag.retriever;
...
public class WebDocumentRetriever implements DocumentRetriever {
    ...
    public WebDocumentRetriever(RestClient.Builder clientBuilder, int resultLimit) {
    ...
    public static class Builder {
        ...
        public WebDocumentRetriever build() {
            return new WebDocumentRetriever(clientBuilder, resultLimit);
        }
    }
}